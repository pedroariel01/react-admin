...
import { newDatabaseCredential } from "../../api/databases";
import { validate, requireDisabledButton } from "../../validations/commons";
import NotificationSystem from "react-notification-system";
import { style } from "../../variables/Variables.jsx";

class DatabaseCredentialNew extends Component {
  state = {
  ...
  onSubmit = e => {
    ...
    newDatabaseCredential(this.state).then(res => {
...
export default DatabaseCredentialNew;
